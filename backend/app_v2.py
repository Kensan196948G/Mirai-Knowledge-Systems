...
from blueprints.ms365 import ms365_bp            # Phase H-3: MS365同期管理移行
from blueprints.operations import operations_bp  # Phase H-3: Incidents/Approvals移行
...
logger.info("[INIT] Blueprints registered: auth_bp, knowledge_bp, dashboard_bp, ms365_bp, operations_bp")
