        ...
        knowledge_list.append(
            {
                ...
                "updated_at": (
                    created_date + timedelta(days=random.randint(0, 30))
                ).isoformat(),
    ...
    templates = [
        {
            ...
            "severity": "medium",
            "corrective_actions": ["玉掛けワイヤー点検強化", "作業半径内立入禁止徹底"],
            "tags": ["クレーン", "ヒヤリハット", "資材"],
        },
        {
            "title": "転落事故 No.{}",
        ...
        },
        {
            ...
            "severity": "medium",
            "corrective_actions": ["埋設物確認の徹底", "試掘実施", "作業手順見直し"],
            "tags": ["設備損傷", "埋設物", "バックホウ"],
        },
    ]
